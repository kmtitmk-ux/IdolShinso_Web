import { type ClientSchema, a, defineData, defineFunction, defineBackend } from '@aws-amplify/backend';
...
export const IsCreateFile = defineFunction({
    name: "IsCreateFile",
    entry: "../functions/IsCreateFile/handler.ts",
    timeoutSeconds: 30
});
